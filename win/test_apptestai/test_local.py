...
def test_project_shorcut(main_homepage):
    ...
    target_project = page.locator(project_title).get_by_text("숏컷")
    try:
...
def test_check_testresult_AOS(main_homepage, write_result, aos_flag):
    ...
    page = main_homepage
    App_CheckList_419_AOS= get_testrun_status_AOS(page, testrun_status)
    write_result("Q476", App_CheckList_419_AOS)
