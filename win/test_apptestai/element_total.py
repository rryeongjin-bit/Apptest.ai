...
#필터박스 os섹션 영역
filter_os_section = "div.sc-euWMRQ goSCLW"

# 필터박스 하단 취소/적용버튼 영역
target_filterbox = (
            "#content_box > div > main > div > div.sc-gytJtb.fnWbHz > div > div.sc-jCDwHD.eaSytZ > div.sc-gPdWHE.kDvSnv > div.sc-joYSUE.VkESz > div > div:nth-child(2)"
        )


testrun_first = "#default-table > tbody > tr:nth-child(1) > td:nth-child(3) > a > div > div > div.sc-eBMEME.jQHsJX"
...
testrun_warningmessage_AOS = "#result-wrapper > div.sc-ckIfTa.kZEXWM > div > div > div.sc-gMZIbH.fCmnFE > div > div"
testrun_passmessage_IOS = "#result-wrapper > div.sc-ckIfTa.kZEXWM > div > div > div.sc-gMZIbH.jwEIEk"
testrun_warningmessage_IOS = "#result-wrapper > div.sc-ckIfTa.kZEXWM > div > div > div.sc-gMZIbH.fCmnFE > div > div"
