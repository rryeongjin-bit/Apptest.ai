...
onestore_usersfile =  "#default-table > tbody > tr:nth-child(3) > td:nth-child(1) > div > div > div"
onestore_preview =  "#default-table > tbody > tr:nth-child(4) > td:nth-child(1) > div > div > div"
onestore_contentshome = "#default-table > tbody > tr:nth-child(5) > td:nth-child(1) > div > div > div"
onestore_tabbar =  "#default-table > tbody > tr:nth-child(6) > td:nth-child(1) > div > div > div"
onestore_launchapp = "#default-table > tbody > tr:nth-child(7) > td:nth-child(1) > div > div > div"
onestore_genrehome ="#default-table > tbody > tr:nth-child(8) > td:nth-child(1) > div > div > div"
onestore_viewer = "#default-table > tbody > tr:nth-child(9) > td:nth-child(1) > div > div > div"

stg_shortcut =  "#default-table > tbody > tr:nth-child(10) > td:nth-child(1) > div > div > div"
stg_widget = "#default-table > tbody > tr:nth-child(11) > td:nth-child(1) > div > div > div"
stg_usersfile =  "#default-table > tbody > tr:nth-child(12) > td:nth-child(1) > div > div > div"
stg_preview =  "#default-table > tbody > tr:nth-child(13) > td:nth-child(1) > div > div > div"
stg_contentshome = "#default-table > tbody > tr:nth-child(14) > td:nth-child(1) > div > div > div"
stg_tabbar =  "#default-table > tbody > tr:nth-child(15) > td:nth-child(1) > div > div > div"
stg_launchapp = "#default-table > tbody > tr:nth-child(16) > td:nth-child(1) > div > div > div"
stg_genrehome ="#default-table > tbody > tr:nth-child(17) > td:nth-child(1) > div > div > div"
stg_viewer = "#default-table > tbody > tr:nth-child(18) > td:nth-child(1) > div > div > div"
