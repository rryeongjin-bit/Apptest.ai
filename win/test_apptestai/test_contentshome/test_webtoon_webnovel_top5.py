...
def test_check_testresult_AOS(main_homepage, aos_flag, sheet):
    ...
    write_result_by_key(sheet, TCID, App_CheckList_coupon_AOS, column="P")
...
def test_check_testresult_IOS(main_homepage, ios_flag, sheet):
    ...
    write_result_by_key(sheet,TCID, App_CheckList_coupon_iOS, column="R")
...
# 비교할 key 값 리스트
keys_to_copy =  [ "App_CheckList_coupon"] 
