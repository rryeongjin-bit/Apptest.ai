...
# [Prod] 뷰어 프로젝트
# -------------------------------
TCID =  [ "App_CheckList_294", "App_CheckList_295", "App_CheckList_296", "App_CheckList_297",
        "App_CheckList_298", "App_CheckList_299", "App_CheckList_300", "App_CheckList_301",
        "App_CheckList_302","App_CheckList_303" ,"App_CheckList_304"]
...
def test_check_testresult_AOS(main_homepage, aos_flag, sheet):
    ...
    write_result_by_key(sheet, TCID, App_CheckList_294_AOS, column="P")
...
def test_check_testresult_IOS(main_homepage, ios_flag, sheet):
    ...
    write_result_by_key(sheet, TCID, App_CheckList_294_iOS, column="R")
...
# 자동화 테스트 결과 비교
# -------------------------------
keys_to_copy = [ "App_CheckList_294", "App_CheckList_295", "App_CheckList_296", "App_CheckList_297",
        "App_CheckList_298", "App_CheckList_299", "App_CheckList_300", "App_CheckList_301",
        "App_CheckList_302","App_CheckList_303" ,"App_CheckList_304"]
