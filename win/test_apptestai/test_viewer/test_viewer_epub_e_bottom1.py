...
def test_testrun_info_AOS(main_homepage, write_result,aos_flag):
    ...
    try:
        ...
        for step in ["S324","S325","S326","S327","S328","S329","S330","S331",
                     "S332","S333","S334"]:
...
def test_check_testresult_AOS(main_homepage, write_result, aos_flag):
    if not aos_flag["run"]:
        for step in ["P324","P325","P326","P327","P328","P329","P330","P331",
                     "P332","P333","P334"]:
    ...
    for step in ["P324","P325","P326","P327","P328","P329","P330","P331",
                "P332","P333","P334"]:
        write_result(step, App_CheckList_318_AOS)
...
def test_testrun_info_IOS(main_homepage,write_result, ios_flag):
    ...
    try:
        ...
        for step in ["T324","T325","T326","T327","T328","T329","T330","T331",
                     "T332","T333","T334"]:
...
def test_check_testresult_IOS(main_homepage, write_result,ios_flag):
    if not ios_flag["run"]:
        for step in ["R324","R325","R326","R327","R328","R329","R330","R331",
                     "R332","R333","R334"]:
            write_result(step, "N/T")
        pytest.skip("⚠️ AOS 테스트 결과 없음 - 결과 확인 skip")
    ...
    for step in ["R324","R325","R326","R327","R328","R329","R330","R331",
                 "R332","R333","R334"]:
        write_result(step, App_CheckList_318_iOS)
