...
def test_testrun_info_AOS(main_homepage, aos_flag, sheet):
    ...
    try:
        AOS_testrun_myridi6.wait_for(state="attached", timeout=5000)
        AOS_testrun_myridi6.scroll_into_view_if_needed()
        AOS_testrun_myridi6.wait_for(state="visible", timeout=5000)
        AOS_testrun_myridi6.click()
...
def test_testrun_info_IOS(main_homepage, ios_flag, sheet):
    ...
    try:
        IOS_testrun_myridi6.wait_for(state="attached", timeout=5000)
        IOS_testrun_myridi6.scroll_into_view_if_needed()
        IOS_testrun_myridi6.wait_for(state="visible", timeout=5000)
        IOS_testrun_myridi6.click()
