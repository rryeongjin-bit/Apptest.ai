...
# [Prod] 뷰어 프로젝트
# -------------------------------
TCID = [ "App_CheckList_374", "App_CheckList_439", "App_CheckList_375", 
        "App_CheckList_376", "App_CheckList_377", "App_CheckList_378"]
...
def test_check_testresult_AOS(main_homepage, aos_flag, sheet):
    ...
    write_result_by_key(sheet, TCID, App_CheckList_374_AOS, column="P")
...
def test_check_testresult_IOS(main_homepage, ios_flag, sheet):
    ...
    write_result_by_key(sheet, TCID, App_CheckList_374_iOS, column="R")
...
# -------------------------------
# 비교할 key 값 리스트
keys_to_copy =  [ "App_CheckList_374", "App_CheckList_439", "App_CheckList_375", 
        "App_CheckList_376", "App_CheckList_377", "App_CheckList_378"]
