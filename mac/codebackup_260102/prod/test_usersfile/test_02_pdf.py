...
"""
def test_004_checkresult_AOS_PDF1(main_homepage):
    page = main_homepage
    apply_filter_checkbox_AOS(page)

def test_005_testrun_info_AOS_PDF1(main_homepage, aos_flag, sheet):
    page = main_homepage
...
def test_006_check_testresult_AOS_PDF1(main_homepage, aos_flag, sheet):
    if not aos_flag["run"]:
...
def test_007_back_testrun_list_AOS_PDF1(main_homepage, aos_flag):
    back_and_or_reset_AOS(main_homepage, aos_flag.get("run", False))

def test_008_checkresult_IOS_PDF1(main_homepage):
    page = main_homepage
    apply_filter_checkbox_iOS(page)

def test_009_testrun_info_IOS_PDF1(main_homepage, ios_flag, sheet):
    page = main_homepage
...
def test_010_check_testresult_PDF1(main_homepage, ios_flag, sheet):
    if not ios_flag["run"]:
...
def test_011_back_testrun_list_IOS_PDF1(main_homepage, ios_flag):
    back_and_or_reset_IOS(main_homepage, ios_flag.get("run", False))

"""
📍[사용자파일] PDF_하단 컨트롤러
"""
def test_012_checkresult_AOS_PDF2(main_homepage):
    page = main_homepage
    apply_filter_checkbox_AOS(page)

def test_013_testrun_info_AOS_PDF2(main_homepage, aos_flag, sheet):
    page = main_homepage
...
def test_014_check_testresult_AOS_PDF2(main_homepage, aos_flag, sheet):
    if not aos_flag["run"]:
...
def test_015_back_testrun_list_AOS_PDF2(main_homepage, aos_flag):
    back_and_or_reset_AOS(main_homepage, aos_flag.get("run", False))

def test_016_checkresult_IOS_PDF2(main_homepage):
    page = main_homepage
    apply_filter_checkbox_iOS(page)

def test_017_testrun_info_IOS_PDF2(main_homepage, ios_flag, sheet):
    page = main_homepage
...
def test_018_check_testresult_IOS_PDF2(main_homepage, ios_flag, sheet):
    if not ios_flag["run"]:
...
def test_019_back_testrun_list_IOS_PDF2(main_homepage, ios_flag):
    back_and_or_reset_IOS(main_homepage, ios_flag.get("run", False))
